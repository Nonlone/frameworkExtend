...
import com.feitai.backend.base.mybatis.ManyAnnotationFieldWalkProcessor;
import com.feitai.backend.base.mybatis.One;
import com.feitai.backend.base.mapper.*;
import com.feitai.backend.base.model.TestExtendModel;
import com.feitai.backend.base.model.TestModel;
import com.feitai.backend.base.model.TestMultipty;
import com.feitai.backend.base.model.TestSingle;
import com.feitai.backend.base.mybatis.OneAnnotationFieldWalkProcessor;
...
//        testModel.setUpdateTime(new Date());
    ...
    @Test
    public void test() {
        String regSource = "12飞钛12科技12";
        Pattern pattern = Pattern.compile("^[A-z1-9]?[\\u4e00-\\u9FFF]+[A-z1-9]?$");
        Matcher matcher = pattern.matcher(regSource);
        if (matcher.find()) {
            System.out.println(regSource + ":" + matcher.groupCount());
            assert  true;
            return;
        }
        assert false;
